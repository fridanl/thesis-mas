...
uv run run.py --model_name gemma-3-4b --repetition 1 --round 2 --batch_size 256 --history --dataset_path /home/rp-fril-mhpe/subsampled_input_round2/sarcasm/gemma-3-4b_disagree_subsampled.csv --outdir  --slurm_output "${SLURM_OUTPUT_FILE}"
