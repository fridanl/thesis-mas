...
#uv run run.py --model_name qwen-2.5-7b --repetition 1 --round 1 --batch_size 256 --dataset_path /home/rp-fril-mhpe/qwen-2.5-7b-sarcasm-failed1.csv --slurm_output "${SLURM_OUTPUT_FILE}"
#uv run run.py --model_name qwen-2.5-72b --repetition 1 --round 1 --batch_size 256 --dataset_path /home/rp-fril-mhpe/qwen-2.5-72b-sarcasm-failed1.csv --slurm_output "${SLURM_OUTPUT_FILE}"
#---
# commonsense
...
# uv run run.py --model_name gemma-3-27b --repetition 1 --round 1 --batch_size 256 --dataset_path /home/rp-fril-mhpe/gemma-3-27b-commonsense-failed1.csv --slurm_output "${SLURM_OUTPUT_FILE}"
# uv run run.py --model_name qwen-2.5-7b --repetition 1 --round 1 --batch_size 256 --dataset_path /home/rp-fril-mhpe/qwen-2.5-7b-commonsense-failed1.csv --slurm_output "${SLURM_OUTPUT_FILE}"
# uv run run.py --model_name qwen-2.5-72b --repetition 1 --round 1 --batch_size 256 --dataset_path /home/rp-fril-mhpe/qwen-2.5-72b-commonsense-failed1.csv --slurm_output "${SLURM_OUTPUT_FILE}"
# uv run run.py --model_name llama-3.3-70b --repetition 1 --round 1 --batch_size 256 --dataset_path /home/rp-fril-mhpe/llama-3.3-70b-commonsense-failed1.csv --slurm_output "${SLURM_OUTPUT_FILE}"
# uv run run.py --model_name llama-3.1-8b --repetition 1 --round 1 --batch_size 256 --dataset_path /home/rp-fril-mhpe/llama-3.1-8b-commonsense-failed1.csv  --slurm_output "${SLURM_OUTPUT_FILE}"
